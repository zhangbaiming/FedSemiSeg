...
class TaskGen(DefaultTaskGen):
    def __init__(self, dist_id, num_clients=4, skewness=0.5, rawdata_path='/data/zbm/polyp', local_hld_rate=0.2, seed=0):
        super(TaskGen, self).__init__(benchmark='polyp_segmentation',
                                      dist_id=dist_id,
